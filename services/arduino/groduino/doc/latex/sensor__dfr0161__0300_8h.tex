...
\begin{DoxyCompactList}\small\item\em This class is used to acquire sensor data for water ph, ec, and temperature. \end{DoxyCompactList}\end{DoxyCompactItemize}
